...
export async function POST(request){
    ...
    if(data){
      console.log("=============   POST.api.estrategia DATA (after token deduction):    ==================")
      console.log(data)
      ...
      return NextResponse.json({ message: "Estrategia de marketing generada exitosamente.", data: savedEstrategiaMarketing }, { status: 201 });
    } else {
